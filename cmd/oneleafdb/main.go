...
func main() {
	...
	dictSamples := flag.String("dict-samples", "", "jsonl key/value samples used to train lz4 dictionary")
	...
	dictLevel := flag.Int("dict-acceleration", compression.DefaultLZ4Acceleration, "LZ4 acceleration")
